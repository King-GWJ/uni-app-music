...
<template>
    <view class="musicPlay">
        <view class="background">
            <image :src="useStore.musicLove.al.picUrl"></image>
        </view>
        <view class="header">
            <p @click="Backprve">
        ...
        <view class="title">
            <view class="songTitle">
                <p class="nameSog"><p class="name">{{ useStore.musicLove.name }}
                                                   {{ useStore.musicLove.alia[0] }}<span>{{ useStore.musicLove.pop }}</span></p></p>
        ...
        <view class="volume">
            ...
            <view class="slider">
                <slider class="sliders" @sliderChange="schedule(1)" min="0"
                        :max="Number(useStore.musicTime.points) * 60 + Number(useStore.musicTime.seconds)"
                        :value="Number(useStore.musicNowTime.points) * 60 + Number(useStore.musicNowTime.seconds)" disabled="true" block-size="20"
